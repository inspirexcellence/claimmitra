...
export const metadata: Metadata = {
  title: "Privacy Policy | InsuranceSarthi",
  description: "Privacy policy for InsuranceSarthi insurance services.",
};
    ...
    <div className="py-20 bg-white min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl prose prose-slate lg:prose-lg">
        ...
        <p className="text-slate-600 mb-4">
          When you use InsuranceSarthi, we collect information you provide directly to us, including your name, contact information (email, phone number), policy documents, medical records (if applicable to your claim), and communication history.
        </p>
        ...
        <p className="text-slate-600 mb-4">
          If you have any questions about this Privacy Policy, please contact us at <strong>privacy@insurancesarthi.com</strong>.
        </p>
      </div>
    </div>
  );
