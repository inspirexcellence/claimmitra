...
export const metadata: Metadata = {
  title: "About Us | InsuranceSarthi",
  description: "Learn about InsuranceSarthi, India's most trusted insurance claim resolution platform.",
};
    ...
    <div className="py-20 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">About InsuranceSarthi</h1>
