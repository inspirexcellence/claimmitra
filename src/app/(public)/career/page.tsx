...
export const metadata: Metadata = {
  title: "Career | Join INSURANCE SAHYOG",
  description: "Join INSURANCE SAHYOG and build a career with purpose. Help us fight for justice in the insurance sector.",
};
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <SlideUp delay={0.1}>
            <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
              At INSURANCE SAHYOG, we don't just process paperwork. We fight for justice, right wrongs, and restore faith for thousands of Indian families. Come join our mission.
            </p>
          </SlideUp>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-5xl">
            ...
            {openings.map((job, i) => (
              <StaggerItem key={i} className="flex flex-col md:flex-row md:items-center justify-between bg-white border border-slate-200 p-6 rounded-2xl hover:border-orange-400 hover:shadow-md transition">
                ...
                <div className="mt-4 md:mt-0">
                  <a href="mailto:careers@insurancesahyog.com">
          ...
          <div className="mt-12 bg-slate-50 rounded-2xl p-8 text-center border border-slate-100">
            ...
            <p className="text-slate-900 font-medium">Drop your resume at <a href="mailto:careers@insurancesahyog.com" className="text-orange-500 hover:underline">careers@insurancesahyog.com</a> and we'll reach out when there's an opening.</p>
          </div>
        </div>
      </section>
    </div>
