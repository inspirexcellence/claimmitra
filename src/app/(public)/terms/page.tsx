...
export const metadata: Metadata = {
  title: "Terms & Conditions | InsurenceSarthi",
  description: "Terms and conditions for using InsurenceSarthi services.",
};
    ...
    <div className="py-20 bg-white min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl prose prose-slate lg:prose-lg">
        ...
        <p className="text-slate-600 mb-4">
          By accessing or using the InsurenceSarthi website and services, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you may not use our services.
        </p>

        <h2 className="text-2xl font-semibold text-slate-800 mt-8 mb-4">2. Description of Service</h2>
        <p className="text-slate-600 mb-4">
          InsurenceSarthi acts as a facilitator and consultant to help policyholders resolve delayed or rejected insurance claims. We are not an insurance company, insurance broker, or a law firm (unless specifically stated in a separate legal representation agreement).
        </p>
        ...
        <p className="text-slate-600 mb-4">
          While we maintain a high success rate, InsurenceSarthi does not guarantee that your claim will be approved. The final decision rests with the insurance company, the Ombudsman, or the Court. We are not liable for the outcome of the claim process.
        </p>
      </div>
    </div>
  );
