  ...
  try {
    ...
    if (image && image.size > 0) {
      ...
      const { data: uploadData, error: uploadError } = await supabase
        .storage
        .from(process.env.S3_BUCKET_NAME || "insurancesahyog-uploads")
      ...
      const publicUrlPrefix = process.env.NEXT_PUBLIC_S3_PUBLIC_URL || "https://vdevakgnmvjvweradcjg.supabase.co/storage/v1/object/public/insurancesahyog-uploads";
