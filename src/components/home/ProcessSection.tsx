...
const steps = [
  {
    number: "01",
    title: "Assess",
    description: "Every claim starts with understanding the details. We carefully review your policy, claim, and supporting documents to identify the right course of action.",
    icon: <FileSearch className="w-8 h-8 text-orange-500" />
  },
  {
    number: "02",
    title: "Prepare",
    description: "A well-prepared claim makes a difference. We help you compile the required documents and ensure everything is in order before submission.",
    icon: <ClipboardCheck className="w-8 h-8 text-orange-500" />
  },
  {
    number: "03",
    title: "Submit",
    description: "Whether it's a fresh claim or a resubmission, we assist you in filing it correctly with all the necessary documentation.",
    icon: <Handshake className="w-8 h-8 text-orange-500" />
  },
  {
    number: "04",
    title: "Support",
    description: "Our guidance doesn't end after submission. We continue to support you by helping you understand updates, respond to queries, and navigate the process with confidence.",
    ...
    <section className="py-24 bg-orange-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <SlideUp>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Your Claim Journey</h2>
          </SlideUp>
          <SlideUp delay={0.1}>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Every claim is unique. Our approach ensures you receive the guidance you need at every stage.
            </p>
          </SlideUp>
        </div>
